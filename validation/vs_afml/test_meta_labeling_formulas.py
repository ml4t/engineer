...
from ml4t.engineer.labeling import meta_labels, compute_bet_size, apply_meta_model
...
class TestBetSizeFormulas:
    ...
    def test_linear_bet_size(self):
        ...
        result = df.with_columns(
            compute_bet_size("prob", method="linear").alias("bet")
        )
    ...
    def test_sigmoid_bet_size_centered(self):
        ...
        result = df.with_columns(
            compute_bet_size("prob", method="sigmoid", scale=1.0).alias("bet")
        )
